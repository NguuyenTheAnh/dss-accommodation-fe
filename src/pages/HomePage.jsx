        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="search-box-wrapper slide-in-up">
              <SearchBox variant="hero" onSearch={handleSearch} onFilterClick={handleFilterClick} />
            </div>
          </div>
        </div>
      </section>
